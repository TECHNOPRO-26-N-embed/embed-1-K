...
// =====================================================
// test_03_sensor_buzzer_display.ino
// 目的: HC-SR04 + ブザー + TM1637表示の統合確認を行う
// =====================================================
...
void outputDisplayMm(int measuredMm);
...
void outputDisplayMm(int measuredMm) {
  ...
  if (measuredMm < 0) {
    measuredMm = 0;
  } else if (measuredMm > 9999) {
    measuredMm = 9999;
  }

  // 先頭ゼロ埋めで4桁表示
  display.showNumberDec(measuredMm, true);
}
